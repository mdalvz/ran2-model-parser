...
exports.ArrayTypeSchema = void 0;
const better_xml_schema_1 = require("better-xml-schema");
const Common_1 = require("../../common/Common");
exports.ArrayTypeSchema = better_xml_schema_1.default.element({
    ...
    member: better_xml_schema_1.default.one(better_xml_schema_1.default.element({
